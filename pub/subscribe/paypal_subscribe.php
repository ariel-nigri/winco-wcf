            ...
            <div class="checkout">
                <div class="left-column">
                    ...
                    <div class="payment-methods section">
                        ...
                        <ul class="nav">
                            ...
                            <!-- tab2 --> 
                            <li class="nav-item">
                                <a class="nav-link" data-method="outros">Outros</a>
                            </li>
                            <!-- end of tab2 --> 
                        </ul>
                        ...
                        <div class="tab-content active" id="paypal">
                            <p><strong>Importante:</strong> O e-mail utilizado para login no portal será o mesmo da sua
                                conta PayPal.</p>
                            <div id="paypal-button-container" style="margin: 5% 0 0 0;"></div>
                        </div>
                        <!-- end of tab1 content -->

                        <!-- tab2 content add more if needed --> 
                        <div class="tab-content" id="outros">
                            <p>Outro metodo de pagamento</p>
                            <div id="paypal-button-container" style="margin: 5% 0 0 0;"></div>
                        </div>
                        <!-- end of tab2 content --> 
                ...
                <div class="right-column">
                    <div class="order-summary">
                        ...
                        <small>Assinatura faturada mensalmente até ser <a href="paypal_account.php">cancelada.</a></small>
                    </div>
                    <div class="total">
                        <span>Total:</span>
