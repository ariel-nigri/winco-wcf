		...
		window[obj_name] = new Object({
			...
			doResize: function(e) {
				...
				if (this.resizing) {
					...
					this.hResize.style.pixelWidth = (this.startH + e.clientX - this.startX);
					alert(this.bResize.tagName + ':' + this.bResize.style.pixelWidth);
					this.bResize.style.pixelWidth = (this.startB + e.clientX - this.startX);
				}
			},
			endResize: function() {
				if (this.resizing) {
